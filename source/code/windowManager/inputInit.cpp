...
std::vector<sf::Keyboard::Key> NameToSFMLKeys(std::vector<std::string>::iterator namesBegin, std::vector<std::string>::iterator namesEnd) {
    std::vector<std::pair<std::string, sf::Keyboard::Key>> table{
        {"A", sf::Keyboard::A},
        {"B", sf::Keyboard::B},
        {"C", sf::Keyboard::C},
        {"D", sf::Keyboard::D},
    ...
    std::vector<sf::Keyboard::Key> res = std::vector<sf::Keyboard::Key>();

    for (auto itName = namesBegin; itName != namesEnd; itName++) {
        std::string currentName = *itName;
        for (auto curr : table) {
            if (curr.first == currentName) {
...
void Input::InitKeys(reference ref) {
    keysMapping.clear();
